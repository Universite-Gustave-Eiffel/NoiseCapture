...
## Developments
NoiseCapture App is a collaboration between the [Environmental Acoustic Reasearch unit](http://www.umrae.fr/en/) ([Ifsttar](http://www.ifsttar.fr)) and the [Lab-STICC](http://www.lab-sticc.fr/) CNRS. If you need more information about the project developped by the Environmental Acoustic Laboratory and the Lab-STICC, on this topic, go to [http://www.noise-planet.org](http://noise-planet.org).
