...
--INSERT INTO noisecapture_party(the_geom, layer_name, title, tag, description, start_time, end_time, filter_time, filter_area) VALUES ((SELECT ST_Envelope(ST_Collect(the_geom)) FROM gadm28 WHERE id_0 =42), 'NoiseCANADA21','Acoustics Week in Canada 2021','NC21','The organizing committee of Acoustics Week in Canada 2021 invites you to contribute to the setup of the largest noise map in Canada in terms of geographical range. This challenge will bring the Canada’s acoustics community together and will provide a concrete output to illustrate its drive and presence while concerns about noise are growing. During AWC21, invite colleagues, students to measure their neighboring sound environment with a smartphone and to contribute to the creation of this noise map in real time with the code #NC21. Visit the "Noise map Canada" booth on the AWC21 conference platform for more information.','2021-07-23T01:00:00Z','2021-10-15T23:59:59Z',true,true);
