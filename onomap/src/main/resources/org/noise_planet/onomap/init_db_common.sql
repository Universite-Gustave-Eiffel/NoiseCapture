...
CREATE TABLE NOISECAPTURE_AREA_PROFILE (
    ...
    CONSTRAINT NOISECAPTURE_AREA_PROFILE_PK PRIMARY KEY (PK_AREA, LOCAL_HOUR),
    CONSTRAINT NOISECAPTURE_AREA_PROFILE_FK FOREIGN KEY (PK_AREA) REFERENCES NOISECAPTURE_AREA (PK_AREA) ON DELETE CASCADE
);

COMMENT ON COLUMN NOISECAPTURE_AREA_PROFILE.LOCAL_HOUR IS 'Hour of estimated value';
...
CREATE UNIQUE INDEX ON noisecapture_area(cell_q, cell_r, pk_party);
