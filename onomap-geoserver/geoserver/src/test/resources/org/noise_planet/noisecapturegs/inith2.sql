...
COMMENT ON COLUMN NOISECAPTURE_AREA.LOCAL_UTC_OFFSET IS 'The amount of time in milliseconds to add to UTC to get local time.';
...
CREATE TABLE NOISECAPTURE_AREA_PROFILE (
    ...
    CONSTRAINT NOISECAPTURE_AREA_PROFILE_FK FOREIGN KEY (PK_AREA) REFERENCES NOISECAPTURE_AREA (PK_AREA)
);
