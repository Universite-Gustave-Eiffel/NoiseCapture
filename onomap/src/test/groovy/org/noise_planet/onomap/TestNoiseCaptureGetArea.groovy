...
class TestNoiseCaptureGetArea extends JdbcTestCase {
  ...
  void testGetAreaProfile() {
    ...
    // Insert measure data
    // insert records
    TestNoiseCaptureProcess.addTestRecord(sql, "2016-09-07T13:43:13Z", "POINT Z(23.73847 37.97503 0)", [70, 75, 72])
    TestNoiseCaptureProcess.addTestRecord(sql, "2016-09-04T18:43:13Z", "POINT Z(23.73847 37.97503 0)", [60, 61, 58])
    TestNoiseCaptureProcess.addTestRecord(sql, "2016-09-03T16:43:13Z", "POINT Z(23.73847 37.97503 0)", [65, 68, 64])
